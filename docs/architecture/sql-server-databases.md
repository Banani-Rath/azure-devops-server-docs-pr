...
description: Azure DevOps on-premises databases
ms.manager: jillfra
ms.author: aaronha
...
# SQL Server databases for Azure DevOps on-premises
...
## Interactions between Azure DevOps Server/TFS and SQL Server Reporting Services
