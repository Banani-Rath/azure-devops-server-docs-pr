...
description: Describes the overall architecture of Azure DevOps on-premises deployments
ms.manager: jillfra
ms.author: aaronha
...
# Architecture overview for Azure DevOps on-premises
...
Collection-level services provide the functionality for operations at the level of the project collection. You can create applications that extend Team Foundation Server by using some of these services. For more information about creating applications for TFS, see [Develop Extensions](/azure/devops/extend/index). 
