...
description: Change the service account or password for Azure DevOps Server or Team Foundation Server
ms.topic: conceptual
ms.manager: jillfra
ms.author: aaronha
...
For more information about service accounts in TFS, see [Service accounts and dependencies in Team Foundation Server](service-accounts-dependencies.md). For more information about the accounts required for installation, including the service account for TFS, see [Service account requirements](../account-requirements.md).
