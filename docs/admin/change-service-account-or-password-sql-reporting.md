...
# Change service credentials for SQL Server Reporting Services for Azure DevOps on-premises 
...
[Service accounts and dependencies in Team Foundation Server](service-accounts-dependencies.md) and
also the topic [Accounts required for installation of Team Foundation Server](service-accounts-dependencies.md) in
...
Server](/azure/devops/security/permissions).
...
1.  Open the administration console for Team Foundation on the server
    ...
    For more information, see [Configure and manage TFS resources](admin-quick-ref.md).
