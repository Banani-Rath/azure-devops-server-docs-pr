...
> [!NOTE]
> For an introduction to restoring data to a different server for TFS, see  [Back up and restore](./back-up-restore.md#diff-server) 
>
...
## Step 9: Redirect TFS to remote collection databases
...
## Step 11: Register the location of the restored databases if you aren't restoring the application tier
