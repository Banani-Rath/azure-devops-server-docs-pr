...
> [!NOTE]
> Check out the [Back up and Restore concepts page](./back-up-restore.md#same-server) for an introduction to restoring data on the same server for TFS. 
>
> SharePoint integration with TFS is deprecated with TFS 2017 and later versions.
