...
For more information, see: [System requirements for Team Foundation Server](/vsts/requirements.md), or [Accounts required for installation of Team Foundation Server](/vsts/requirements.md#accounts).
