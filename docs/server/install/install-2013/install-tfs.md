...
For more information, see: [SQL Server requirements for Team Foundation Server](/tfs/requirements#sql-server), [Manually install SQL Server for Team Foundation Server](../sql-server/install-sql-server)
...
For more information, see [SharePoint Products requirements for Team Foundation Server](/tfs/requirements#sharepoint), [Manually Install SharePoint products for Team Foundation Server](../sharepoint/install-sharepoint)
